...
1. Perceived Stress: 1(not stressed)-5(very stressed)
  + Outcome Variable
  + Continuous
2. Condition: condition 1:non-stigmatized, 2= stigmatized
  + Predictor Variable
  + Categorical
...
The interaction between stigma and perceived stress on emotional valence was not significant. This finding was not aligned with our hypothesis. This result could be due to an inadequate sample size or it could be that there is no relationship between stigma and stress.
...
plot <- ggplot(data, aes(x= PSS, y=mat_valence, color=Condition)) +
  ...
  scale_color_manual(values=c("lightpink","orchid4")) 
